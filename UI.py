...
left_middle_frame.grid(row=0, column=1, padx=10, pady=10, sticky="nsew")
...
right_middle_frame.grid(row=0, column=3, padx=10, pady=10, sticky="nsew")

right_frame = tk.Frame(root, bg="grey")
right_frame.grid(row=0, column=4, padx=10, pady=10, sticky="nsew")
...
image_bad = PhotoImage(file="Unhappy Face.png")
